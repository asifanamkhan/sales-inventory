<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">
            <i class="fa-solid fa-cart-shopping"></i> Product expire report
        </h3>
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Reports</a></li>
                <li class="breadcrumb-item active"><a wire:navigate href="" style="color: #3C50E0">Product expire
                        report</a></li>
            </ol>
        </nav>
    </div>
        ...
        <div>
            <div style="display: flex; justify-content: space-between" class="p-2">
                ...
                <div style="float: right">
                    <form target="_blank" action="{{route('product-expire-report-pdf')}}" method="post">
                        @csrf
            ...
            <div class="responsive-table" style="font-size: 0.9em !important;">
                <table class="table table-bordered table-hover">
                    ...
                    <tfoot>
                        ...
                        <th style="text-align: center">{{ number_format($t_qty, 2, '.', '') }}</th>
                        <th style="text-align: right"></th>
                        {{-- <th style="text-align: right">{{ number_format($t_stock, 2, '.', '') }}</th> --}}
                    </tfoot>
