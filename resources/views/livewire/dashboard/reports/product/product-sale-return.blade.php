<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">
            <i class="fa-solid fa-cart-shopping"></i> Product sale return report
        </h3>
        ...
        <div>
            <div style="display: flex; justify-content: space-between" class="p-2">
                ...
                <div style="float: right">
                    <form target="_blank" action="{{route('product-sale-return-report-pdf')}}" method="post">
                        @csrf
            ...
            <div class="responsive-table" style="font-size: 0.9em !important;">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="bg-sidebar">
                            <td style="">#</td>
                            <td style="width:9%">RT Date</td>
                            <td style="">RT no</td>
                            <td style="text-align: center">Item</td>
                            <td style="text-align: center">Branch</td>
                            <td style="text-align: center">RT Qty</td>
                    ...
                    <tbody>
                        ...
                        <tr wire:key='{{ $key }}'>
                            ...
                            @endphp
                            <td>{{ $key+1 }}</td>
                            <td>{{ date('d-M-y', strtotime($ledger->return_date)) }}</td>
                            <td>{{ $ledger->return_no }}</td>
                            <td>
                                {{ $ledger->item_name }}
                            ...
                            <td style="text-align: center">{{ $ledger->return_qty }} {{ $ledger->unit_name }}</td>
