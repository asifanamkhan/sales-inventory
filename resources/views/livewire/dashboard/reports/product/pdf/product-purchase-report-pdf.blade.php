    ...
    <table class="invoice-items" cellspacing="0" cellpadding="4">
        <thead>
            <tr>
                ...
                <td class="invoice-items-head" style="width:14%;">Puchase no</td>
        ...
        <tbody>
            ...
            <tr wire:key='{{ $key }}'>
                ...
                <td style="width:11%">{{ date('d-M-y', strtotime($ledger->tran_date)) }}</td>
                <td style="width:14%">{{ $ledger->purchase_no }}</td>
                ...
                <td style="text-align: right; width:10%;">{{ $ledger->item_qty }} {{ $ledger->unit_name }}</td>
                ...
                <td style="text-align: right; width: 12%">{{ number_format($ledger->tot_payble_amt, 1, '.', '') }}</td>
