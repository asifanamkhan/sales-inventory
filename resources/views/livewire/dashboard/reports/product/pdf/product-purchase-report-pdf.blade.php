    ...
    <table class="invoice-items" cellspacing="0" cellpadding="4">
        <thead>
            <tr>
                ...
                <td class="invoice-items-head" style="width:12%;">Puchase no</td>
        ...
        <tbody>
            ...
            <tr wire:key='{{ $key }}'>
                ...
                <td style="width:12%">{{ $ledger->purchase_no }}</td>
                ...
                <td style="text-align: right; width:7%;">{{ $ledger->item_qty }}</td>
                ...
                <td style="text-align: right; width: 12%">{{ number_format($ledger->tot_payble_amt, 2, '.', '') }}</td>
