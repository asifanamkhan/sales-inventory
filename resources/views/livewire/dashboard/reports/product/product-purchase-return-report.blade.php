<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">
            <i class="fa-solid fa-cart-shopping"></i> Product purchase return report
        </h3>
        ...
        <div>
            <div style="display: flex; justify-content: space-between" class="p-2">
                ...
                <div style="float: right">
                    <form target="_blank" action="{{route('product-purchase-return-report-pdf')}}" method="post">
                        @csrf
