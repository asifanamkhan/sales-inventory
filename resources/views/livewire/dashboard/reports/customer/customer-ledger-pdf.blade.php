    ...
    <table class="invoice-items" cellspacing="0" cellpadding="2">
        ...
        <tbody>
            ...
            <tr style="page-break-inside: avoid">
                ...
                <td style="text-align: right;width:14%">{{ number_format($ledger->total_paid_amt, 1, '.', ',') }}</td>
                <td style="text-align: right;width:11%">{{ number_format($ledger->tot_return_amt, 1, '.', ',') }}</td>
                <td style="text-align: right;width:11%">{{ number_format($ledger->sales_ret_paid, 1, '.', ',') }}</td>
                <td style="text-align: right;width:11%">{{ number_format($ledger->receiveable_amt, 1, '.', ',') }}</td>
                <td style="text-align: right;width:11%">{{ number_format($ledger->tot_due_amt, 1, '.', ',') }}</td>
