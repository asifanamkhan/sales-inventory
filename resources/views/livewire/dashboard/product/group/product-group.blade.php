<div>
    <div wire:loading class="spinner-border text-primary custom-loading" product-group="status">
        <span class="sr-only">Loading...</span>
    </div>
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">
            <i class="fa-solid fa-layer-group"></i> Product groups
        </h3>
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Product</a></li>
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('product-group') }}"
                        style="color: #3C50E0">groups</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            <div class="col-auto">
                <button @click="$dispatch('create-product-group-modal')" type="button" class="btn btn-primary"
            ...
            {{-- modal --}}
            <x-modal :modalTitle='$modal_title' :eventName='$event'>
                <livewire:dashboard.product.group.product-group-form />
            </x-modal>
        </div>
        ...
        <span>{{ $this->resultGroup->links() }}</span>
    </div>
</div>
