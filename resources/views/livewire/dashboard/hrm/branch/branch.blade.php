<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">Branches</h3>
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="#">Hrm</a></li>
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('branch') }}" style="color: #3C50E0">branchs</a></li>
            </ol>
        </nav>
    </div>
    <div>
        {{-- <livewire:dashboard.create-branch /> --}}
    </div>
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            <x-modal :modalTitle='$create_title' :eventName='$create_event'>
                <livewire:dashboard.hrm.branch.branch-form/>
            </x-modal>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <td class="bg-sidebar" style="width: 30%">Branch name</td>
                ...
                <tbody>
                    ...
                    <tr wire:key='{{ $key }}'>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <button @click="$dispatch('branch-edit-modal', {id: {{ $branch->branch_id }}})" data-toggle="modal"
                                ...
                                {{-- <button class="btn btn-sm btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 24 24">
                                        <path fill=white d="M 10 2 L 9 3 L 3 3 L 3 5 L 4.109375 5 L 5.8925781 20.255859 L 5.8925781 20.263672 C 6.023602 21.250335 6.8803207 22 7.875 22 L 16.123047 22 C 17.117726 22 17.974445 21.250322 18.105469 20.263672 L 18.107422 20.255859 L 19.890625 5 L 21 5 L 21 3 L 15 3 L 14 2 L 10 2 z M 6.125 5 L 17.875 5 L 16.123047 20 L 7.875 20 L 6.125 5 z"></path>
                                        </svg>
                                </button> --}}
                            </div>
                        </td>
        ...
        <span>{{ $this->resultBranch->links() }}</span>
    </div>
</div>
