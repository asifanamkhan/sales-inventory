<div>
    <div wire:loading class="spinner-border text-primary custom-loading" employee="status">
        <span class="sr-only">Loading...</span>
    </div>
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">
            <i class="fas fa-users"></i> Employees</h3>
    ...
    <div class="card p-4">
        ...
        <span>{{ $this->resultEmployee->links() }}</span>
    </div>
</div>
