<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">Suppliers</h3>
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="#">Hrm</a></li>
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('supplier') }}" style="color: #3C50E0">suppliers</a></li>
            </ol>
        </nav>
    </div>
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            <div class="col-auto">
                <a wire:navigate href='{{ route('supplier-create') }}' class="btn btn-primary">
                    Create supplier
                </a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr wire:key='{{ $key }}'>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <a wire:navigate href='{{ route('supplier-edit', $supplier->p_code) }}'
        ...
        <span>{{ $this->resultSupplier->links() }}</span>
    </div>
</div>
