    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        ...
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('department') }}"
                        style="color: #3C50E0">departments</a></li>
            </ol>
        </nav>
    </div>
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            {{-- --}}
            <div class="col-auto">
                <button @click="$dispatch('create-department-modal')" type="button" class="btn btn-primary"
                ...
                <tbody>
                    ...
                    <tr wire:key='{{ $key }}'>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <button @click="$dispatch('department-edit-modal', {id: {{ $department->dept_id }}})"
