<div>
    <div wire:loading class="spinner-border text-primary custom-loading" department="status">
        <span class="sr-only">Loading...</span>
    </div>
    <div style="display: flex; justify-content: space-between; align-items:center">
        <h3 style="padding: 0px 5px 10px 5px;">Departments</h3>
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="#">Hrm</a></li>
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('department') }}" style="color: #3C50E0">departments</a></li>
            </ol>
        </nav>
    </div>
    <div class="card p-4">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <td class="bg-sidebar" style="width: 30%">Department name</td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <button @click="$dispatch('department-edit-modal', {id: {{ $department->dept_id }}})" data-toggle="modal"
        ...
        <span>{{ $this->resultDepartment->links() }}</span>
    </div>
</div>
