<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        ...
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('expense-category') }}" style="color: #3C50E0">category</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            <div class="col-auto">
                <button @click="$dispatch('create-expense-cat-modal')" type="button" class="btn btn-primary" data-toggle="modal"
                ...
                <tbody>
                    ...
                    <tr wire:key='{{ $key }}'>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <button @click="$dispatch('expense-cat-edit-modal', {id: {{ $expense->expense_id }}})" data-toggle="modal"
