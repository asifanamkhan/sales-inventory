        ...
        <div class="row" x-data="{edit : false}">
            ...
            <div class="col-md-12 mt-4 table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @forelse ($saleCart as $sale_key => $purchase)
                        ...
                        >
                            ...
                            <td>
                                <input tabindex="-1" type="number" style="text-align: right" readonly
                                    class="form-control" wire:model='saleCart.{{ $sale_key }}.line_total'>
                            </td>
            ...
            <div class="col-md-7">
                <div class="form-group">
                    <label for="">Sale return remarks </label>
                    <livewire:quill-text-editor wire:model="state.remarks" theme="snow" />
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <label for="">Sale return documents </label>
